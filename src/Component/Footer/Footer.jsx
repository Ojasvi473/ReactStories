    ...
    <>
      <footer id="footer">
        <div class="Footer__Column1">
          <h3 class="Footer__header">EDYODA</h3>
          <div class="list1">
            <a href="#">About Us</a>
            <a href="#">Careers</a>
            <a href="#">Contact Us</a>
            ...
            <img
              class="im"
              src="https://www.edyoda.com/static/media/startup-india.75c895fb.svg"
            ></img>
          </div>
        </div>

        <div class="Footer__Column12">
          <h3 class="Footer__header">CAREER TRACKS</h3>
          <h6 style={{ marginTop: "7px" }}> TECH</h6>
          <a href="#" style={{ marginTop: "-15px" }}>
            React Developer
          </a>
          <a href="#">Full Stack Developer</a>
          <a href="#">Data Scientist</a>
          <a href="#">Software Developement Engineer</a>
          <h6 style={{ marginTop: "10px" }}>BUSINESS</h6>
          <a
            href="#"
            target="_blank"
            rel="noopener"
        ...
        <div class="Footer__Column0">
          <h3 class="Footer__header">MICRO DEGREE</h3>
          <h6 style={{ marginTop: "7px" }}> TECH</h6>
          <a href="#" style={{ marginTop: "-15px" }}>
            AI ML Micro Degree
          </a>
          <a href="#">React JS Micro Degree</a>
          <a href="#">Web Development Micro Degree</a>
          ...
          <a
            ...
            style={{ marginTop: "-18px" }}
          >
            Digital Marketing Micro Degree
          </a>
          <a href="#">Business Development Professional</a>
        </div>
        <div class="Footer__Column2">
          <h3 class="Footer__header" style={{ marginTop: "-1%" }}>
            RESOURCES
          </h3>
          <a href="#">Jobs</a>
        ...
        <div class="Footer__Column3">
          ...
          <h3 class="Footer__header" style={{ marginBottom: "10px" }}>
            QUICK LINKS
          </h3>
          ...
          <a href="#">Affiliate Progam</a>
        </div>
        <div class="f1">
          <h2 class="Footer__header" style={{ marginTop: "-1%" }}>
            Connect
          </h2>
          <div class="a2">
            <a class="a3">
            ...
            <img
              ...
              class="Email"
            />
            <p id="email">hello@edyoda.com</p>
            <div class="icon">
              <div class="icon1" style={{ marginRight: " 3%" }}>
